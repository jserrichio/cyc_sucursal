...
begin
  ...
  self.Caption := 'Modificar stock en fábrica';
...
begin
  ...
  self.Caption := 'Consultar stock en fábrica';
end;
  ...
  begin
    ...
    datamodule1.QstockTotal.SQL.Add(
      'select * from producto p left join talle_pantalon tp on p.id_prod = tp.id_prod '
        + 'left join talle_remera tr on p.id_prod = tr.id_prod left join talle_cinturon tc on p.id_prod = tc.id_prod ' + 'where p.num_prod like ' + QuotedStr('%' + LabeledEdit5.Text + '%')+' and p.activo=1');
  ...
  begin
    ...
    begin
      ...
      datamodule1.QstockRemera.SQL.Add(
        'select * from producto p left join talle_remera tr on p.id_prod = tr.id_prod where p.tipo_prod="remera" and ' + 'p.num_prod like ' + QuotedStr('%' + LabeledEdit5.Text + '%')+' and p.activo=1');
    ...
    begin
      ...
      begin
        datamodule1.QstockRemera.SQL.Clear;
        datamodule1.QstockRemera.SQL.Add(
          'select * from producto p left join talle_pantalon tp on p.id_prod = tp.id_prod where p.tipo_prod="pantalon" and ' + 'p.num_prod like ' + QuotedStr('%' + LabeledEdit5.Text + '%')+' and p.activo=1');
        datamodule1.QstockRemera.Open;
        datamodule1.QstockRemera.Active := true;
      end
      else
      begin
        ...
        begin
          datamodule1.QstockRemera.SQL.Clear;
          datamodule1.QstockRemera.SQL.Add(
            'select * from producto p left join talle_cinturon tc on p.id_prod = tc.id_prod where p.tipo_prod="cinturon" and ' + 'p.num_prod like ' + QuotedStr('%' + LabeledEdit5.Text + '%')+' and p.activo=1');
          datamodule1.QstockRemera.Open;
          datamodule1.QstockRemera.Active := true;
        end
        else
        begin
          ...
          begin
            ...
            datamodule1.QstockMedia.SQL.Add(
              'select * from producto p left join talle_media tm on p.id_prod = tm.id_prod where p.tipo_prod="media" and ' + 'p.num_prod like ' + QuotedStr('%' + LabeledEdit5.Text + '%')+' and p.activo=1');
          ...
          begin
            ...
            begin
              ...
              datamodule1.QstockBolsa.SQL.Add(
                'select * from producto p left join talle_bolsa tb on p.id_prod = tb.id_prod where p.tipo_prod="bolsa" and ' + 'p.num_prod like ' + QuotedStr('%' + LabeledEdit5.Text + '%')+' and p.activo=1');
...
begin
  ...
  begin
    ...
    datamodule1.QstockTotal.SQL.Add(
      'select * from producto p left join talle_pantalon tp on p.id_prod = tp.id_prod '
        + 'left join talle_remera tr on p.id_prod = tr.id_prod left join talle_cinturon tc on p.id_prod = tc.id_prod ' + 'where p.nombre_prod like ' + QuotedStr('%' + LabeledEdit1.Text + '%')+' and p.activo=1');
    datamodule1.QstockTotal.Open;
    datamodule1.QstockTotal.Active := true;
  end
  else
  begin
    ...
    begin
      datamodule1.QstockRemera.SQL.Clear;
      datamodule1.QstockRemera.SQL.Add(
        'select * from producto p left join talle_remera tr on p.id_prod = tr.id_prod where p.tipo_prod="remera" and ' + 'p.nombre_prod like ' + QuotedStr('%' + LabeledEdit1.Text + '%')+' and p.activo=1');
      datamodule1.QstockRemera.Open;
      datamodule1.QstockRemera.Active := true;
    end
    else
    begin
      ...
      begin
        datamodule1.QstockRemera.SQL.Clear;
        datamodule1.QstockRemera.SQL.Add(
          'select * from producto p left join talle_pantalon tp on p.id_prod = tp.id_prod where p.tipo_prod="pantalon" and ' + 'p.nombre_prod like ' + QuotedStr('%' + LabeledEdit1.Text + '%')+' and p.activo=1');
        datamodule1.QstockRemera.Open;
        datamodule1.QstockRemera.Active := true;
      end
      else
      begin
        ...
        begin
          datamodule1.QstockRemera.SQL.Clear;
          datamodule1.QstockRemera.SQL.Add(
            'select * from producto p left join talle_cinturon tc on p.id_prod = tc.id_prod where p.tipo_prod="cinturon" and ' + 'p.nombre_prod like ' + QuotedStr('%' + LabeledEdit1.Text + '%')+' and p.activo=1');
          datamodule1.QstockRemera.Open;
          datamodule1.QstockRemera.Active := true;
        end
        else
        begin
          ...
          begin
            datamodule1.QstockMedia.SQL.Clear;
            datamodule1.QstockMedia.SQL.Add(
              'select * from producto p left join talle_media tm on p.id_prod = tm.id_prod where p.tipo_prod="media" and ' + 'p.nombre_prod like ' + QuotedStr('%' + LabeledEdit1.Text + '%')+' and p.activo=1');
            datamodule1.QstockMedia.Open;
            datamodule1.QstockMedia.Active := true;
          end
          else
          begin
            ...
            begin
              datamodule1.QstockBolsa.SQL.Clear;
              datamodule1.QstockBolsa.SQL.Add(
                'select * from producto p left join talle_bolsa tb on p.id_prod = tb.id_prod where p.tipo_prod="bolsa" and ' + 'p.nombre_prod like ' + QuotedStr('%' + LabeledEdit1.Text + '%')+' and p.activo=1');
              datamodule1.QstockBolsa.Open;
              datamodule1.QstockBolsa.Active := true;
...
begin
 if MessageDlg('¿Eliminar el producto '+datamodule1.producto.FieldByName('nombre_prod').AsString+'?', mtCustom,
...
begin
  self.actualizarPunteroProducto;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              begin
                // ACA HAY QUE PONER QUE HACER CUANDO ES NIÑOS!
...
begin
  ...
  begin
    datamodule1.QstockTotal.SQL.Clear;
    datamodule1.QstockTotal.SQL.Add(
      'select * from producto p left join talle_pantalon tp on p.id_prod = tp.id_prod ' + 'left join talle_remera tr on p.id_prod = tr.id_prod left join talle_cinturon tc on p.id_prod = tc.id_prod where p.sexo_prod="hombre"'+' and p.activo=1');
    datamodule1.QstockTotal.Open;
    datamodule1.QstockTotal.Active := true;
  end
  else
  begin
    ...
    begin
      datamodule1.QstockRemera.SQL.Clear;
      datamodule1.QstockRemera.SQL.Add(
        'select * from producto p left join talle_remera tr on p.id_prod = tr.id_prod where p.tipo_prod="remera" and p.sexo_prod="hombre"'+' and p.activo=1');
      datamodule1.QstockRemera.Open;
      datamodule1.QstockRemera.Active := true;
    end
    else
    begin
      ...
      begin
        datamodule1.Qstockpantalon.SQL.Clear;
        datamodule1.Qstockpantalon.SQL.Add(
          'select * from producto p left join talle_pantalon tp on p.id_prod = tp.id_prod where p.tipo_prod="pantalon" and p.sexo_prod="hombre"'+' and p.activo=1');
        datamodule1.Qstockpantalon.Open;
        datamodule1.Qstockpantalon.Active := true;
      end
      else
      begin
        ...
        begin
          datamodule1.Qstockcinturon.SQL.Clear;
          datamodule1.Qstockcinturon.SQL.Add(
            'select * from producto p left join talle_cinturon tc on p.id_prod = tc.id_prod where p.tipo_prod="cinturon" and p.sexo_prod="hombre"'+' and p.activo=1');
          datamodule1.Qstockcinturon.Open;
          datamodule1.Qstockcinturon.Active := true;
        end
        else
        begin
          ...
          begin
            datamodule1.QstockMedia.SQL.Clear;
            datamodule1.QstockMedia.SQL.Add(
              'select * from producto p left join talle_media tm on p.id_prod = tm.id_prod where p.tipo_prod="media" and p.sexo_prod="hombre"'+' and p.activo=1');
            datamodule1.QstockMedia.Open;
            datamodule1.QstockMedia.Active := true;
          end
          else
          begin
            ...
            begin
              datamodule1.QstockBolsa.SQL.Clear;
              datamodule1.QstockBolsa.SQL.Add(
                'select * from producto p left join talle_bolsa tb on p.id_prod = tb.id_prod where p.tipo_prod="bolsa" and p.sexo_prod="hombre"'+' and p.activo=1');
              datamodule1.QstockBolsa.Open;
              datamodule1.QstockBolsa.Active := true;
            end;
          end;
...
begin
  ...
  begin
    datamodule1.QstockTotal.SQL.Clear;
    datamodule1.QstockTotal.SQL.Add(
      'select * from producto p left join talle_pantalon tp on p.id_prod = tp.id_prod ' + 'left join talle_remera tr on p.id_prod = tr.id_prod left join talle_cinturon tc on p.id_prod = tc.id_prod where p.sexo_prod="dama"'+' and p.activo=1');
    datamodule1.QstockTotal.Open;
    datamodule1.QstockTotal.Active := true;
  end
  else
  begin
    ...
    begin
      datamodule1.QstockRemera.SQL.Clear;
      datamodule1.QstockRemera.SQL.Add(
        'select * from producto p left join talle_remera tr on p.id_prod = tr.id_prod where p.tipo_prod="remera" and p.sexo_prod="dama"'+' and p.activo=1');
      datamodule1.QstockRemera.Open;
      datamodule1.QstockRemera.Active := true;
    end
    else
    begin
      ...
      begin
        datamodule1.Qstockpantalon.SQL.Clear;
        datamodule1.Qstockpantalon.SQL.Add(
          'select * from producto p left join talle_pantalon tp on p.id_prod = tp.id_prod where p.tipo_prod="pantalon" and p.sexo_prod="dama"'+' and p.activo=1');
        datamodule1.Qstockpantalon.Open;
        datamodule1.Qstockpantalon.Active := true;
      end
      else
      begin
        ...
        begin
          datamodule1.Qstockcinturon.SQL.Clear;
          datamodule1.Qstockcinturon.SQL.Add(
            'select * from producto p left join talle_cinturon tc on p.id_prod = tc.id_prod where p.tipo_prod="cinturon" and p.sexo_prod="dama"'+' and p.activo=1');
          datamodule1.Qstockcinturon.Open;
          datamodule1.Qstockcinturon.Active := true;
        end
        else
        begin
          ...
          begin
            datamodule1.QstockMedia.SQL.Clear;
            datamodule1.QstockMedia.SQL.Add(
              'select * from producto p left join talle_media tm on p.id_prod = tm.id_prod where p.tipo_prod="media" and p.sexo_prod="dama"'+' and p.activo=1');
            datamodule1.QstockMedia.Open;
            datamodule1.QstockMedia.Active := true;
          end
          else
          begin
            ...
            begin
              datamodule1.QstockBolsa.SQL.Clear;
              datamodule1.QstockBolsa.SQL.Add(
                'select * from producto p left join talle_bolsa tb on p.id_prod = tb.id_prod where p.tipo_prod="bolsa" and p.sexo_prod="dama"'+' and p.activo=1');
              datamodule1.QstockBolsa.Open;
              datamodule1.QstockBolsa.Active := true;
            end;
          end;
